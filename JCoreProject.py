...
keywords_to_remove = [
    r"사이즈 선택:",r"향 선택:", r"모델명:",r"수량:",r":\d+\.",r"/\d+\.","차량용", "벤오토", "센트럴리빙", "컵홀드", "종류","와이퍼", r"제품:\d+\.?", r"\(\+\d+원\)", r"\(\-\d+원\)", r"\d+-\d+\.",r"\(\d+원\)",
    ...
    r"브랜드=", r"모델명=","차종",r"추가:",r"추가 :","코란도","선택"
]

keyword_replacements = {
    "^": " ", "자동차 초미세모  세차":" ", "자동차 초미세모 세차":" ", "운전석 조수석 세트": " ",r"[1+1 원쁠]":" ","자동차 청소 디테일링 초미세모":" ",
    r"(1대분은 ★2개★ 구매바랍니다.)":"", r"=(1103~1506)":" ",r"(배송매세지에남겨주세요)":" ",
    ...
    r"SM3 뉴 (098~14년)":" ",r"SM3 (05~09년)":" ",r"SM5 뉴플래티넘노바": " ",r"SM5 임프레션(05~09)":" ",
...
def convert_shop_name(shop_name, product_name, option):
    ...
    # "쿠팡"에 대한 처리
    if shop_name == "쿠팡":
        if any(keyword in first_file_data['쇼핑몰'].tolist() for keyword in ["현대이지웰", "신세계몰(신)", "브랜디", "센트럴리빙", "카카오톡스토어", "텐바이텐"]):
