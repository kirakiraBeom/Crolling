...
keywords_to_remove = [
    r"향 선택:", "차량용", "벤오토", "센트럴리빙", "컵홀드", "종류","와이퍼", r"제품:\d+\.?", r"\(\+\d+원\)", r"\(\-\d+원\)", r"\d+-\d+\.",
...
keyword_replacements = {
    ...
    r"그랜저 HG （11 01~）":" ", r"더뉴그랜저IG （20~）":" ",

    r"올뉴모닝(1701~)": " ", r"올뉴모닝(1701~)": " ",r"모닝올뉴모닝(04~16)":" ",

    r"투싼NX4 (2009~)":" ",r"올뉴투싼 (1503~)":" ",r"투싼ix （0908~）":" ",r"투싼 （0404~0907）":" ",
    ...
    r"아반떼 HD(0605)": " ", r"아반떼 HD（06／05）":" ", r"아반떼XD （004~065）":" ", r"아반떼 XD 후방 단품":" ", r"아반떼 MD쿠페 （1008）":" ",
    ...
    r"올뉴마이티":" ", r"마이티 II":" ",r"마이티 I （8604~）":" ",
    
    r"더뉴그랜드(18년~)":" ", r"그랜드 （0705~18년）":" ",

    r"베라크루즈 (11년~15년)":" ",r"베라크루즈 뉴（11년~15년）":" ",

    r"카운티":" ", r"카운티 후방 단품":" ",

    r"올뉴말리부(1604~)":" ", r"말리부（~1603）":" ",
